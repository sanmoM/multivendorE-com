...
export default function AddressInfo() {
    ...
    return (
        <div className="mx-auto px-5 max-sm:block hidden relative">
            <i
            ...
            <div
                id="dashboardContent"
                className={`my-5 bg-white w-[300px] h-fit top-4 absolute transition-all !duration-300 left-0 p-5 rounded-md ease-in-out sm:hidden z-50 ${categoryOpen ? 'translate-x-0' : "-translate-x-full"}`}
            >
