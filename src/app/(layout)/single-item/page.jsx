    ...
    return (
        <div className="px-4 lg:px-8">
            <div className="flex flex-col lg:flex-row">
                ...
                <div className="lg:w-1/3 px-4 lg:pl-10 lg:pr-0 flex flex-col">
                    <h2 className="text-lg font-semibold text-primary mb-4">Seller</h2>
                    ...
                    <div className="flex items-center rounded-lg mb-6">
                        <Image
                            ...
                            // onError={(e) => { e.target.onerror = null; e.target.src = "https://placehold.co/40x40/FFEDD5/F59E0B?text=Error"; }}
                            width={40}
                            height={40}
                        />
                        <div>
                    ...
                    <div className="flex space-x-3">
                        {/* <button className=" bg-orange-400 text-primary font-semibold py-2 px-4 rounded-full transition-colors duration-200">
                            Contact Seller
                        </button> */}
                        <Button text="Contact Seller" />
                        {/* <button className="text-gray-700 font-semibold py-2 px-4 rounded-full bg-tertiary hover:bg-gray-100 transition-colors duration-200 w-fit">
                            Follow
                        </button> */}
                    ...
                    <div className="mt-6 border-gray-200">
                        {/* <h3 className="text-lg font-semibold text-primary mb-2">Custom Cake Order</h3> */}
                        {/* <SectionTitle title="Custom Cake Order" /> */}
                        ...
                        {/* <button className="text-primary text-sm font-semibold bg-tertiary">
                            Custom Order Form
                        </button> */}
