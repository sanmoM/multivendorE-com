        ...
        <div>
            ...
            >
                ...
                <div className="w-full">
                    <div className="p-3">
                        <div className="max-sm:block max-sm:items-center max-sm:gap-3">
                            <a href="/user_profile.html">
                                <button
                        ...
                        <div className="flex max-md:flex-col-reverse gap-5 py-5">
                            <div
                                className="w-[60%] max-md:w-full max-sm:w-full p-5 min-h-screen border rounded-sm"
                            >
                                <div className="w-full max-w-md mx-auto px-4 max-sm:px-0 py-3">
                                ...
                                <div className="w-full max-w-md mx-auto px-4 max-sm:px-0 py-3">
                                    <div className="flex flex-col gap-2">
                                        <label for="lname" className="text-[16px] max-sm:text-[14px]"
                                        >Last Name</label
                                        >
                                        <input
                                            type="text"
                                ...
                                <div className="w-full max-w-md mx-auto px-4 max-sm:px-0 py-3">
                                    <div className="flex flex-col gap-2">
                                        <label for="email" className="text-[16px] max-sm:text-[14px]"
                                        >Email Address</label
                                        >
                                        <input
                                            type="email"
                                ...
                                <div className="w-full max-w-md mx-auto px-4 max-sm:px-0 py-3">
                                    <div className="flex flex-col gap-2">
                                        <label for="phone" className="text-[16px] max-sm:text-[14px]"
                                        >Phone Number</label
                                        >
                                        <input
                                            type="number"
